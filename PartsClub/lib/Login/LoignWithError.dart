...
class LoginPageWithError extends StatefulWidget {
  const LoginPageWithError({Key key}) : super(key: key);
  @override
  _LoginPageWithErrorState createState() => _LoginPageWithErrorState();
}
                                ...
                                child: new Padding(padding:  const EdgeInsets.only(
                                  ...
                                  child: Row(
                                      children: <Widget>[
                                        ...
                                        Text('  User ID / Password incorrect   ! ', style: TextStyle(color: Colors.black,fontSize: 18),),
